% 11-30-2018: added global variable check
% added pause(1) to solve the CyUSB problem
% 08-16-19: added setBlack
...
classdef OL490Class < handle
    ...
    methods
        ...
        %%
        function setBlack (obj, lambda, bandwidth)
            obj.setPeak(lambda, bandwidth, 0);
        end
    end
end