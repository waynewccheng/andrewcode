%% From Mathworks file exchange, code by A.J. Johnson

% https://www.mathworks.com/matlabcentral/fileexchange/4705-error_ellipse

% 09-12-19: copied from the web + modif to export the coordiantes of the
% ellipses

function [h, xyz_h1, xyz_h2, xyz_h3] = error_ellipse(varargin)
