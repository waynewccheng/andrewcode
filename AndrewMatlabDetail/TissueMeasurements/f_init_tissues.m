...
% 11-15-19: cahnge name to f_init_tissues

% 09-26-19: first implementation based on init_filters (in FilterMeasurements folder)

function [p_sample, p_white, p_trans, p_cie, p_er, p_st] = f_init_tissues(name_of_sample)
...
%     cam.close;
    ...
    % Paths
    p_rdata = ['D:\AndrewData\RawData\' date_strp '\' name_of_sample];
    p_pdata = ['D:\AndrewData\ProcessedData\' date_strp '\' name_of_sample];
    ...
    p_st = 'C:\Users\wcc\Desktop\MatlabCode_Paul\PointGreySpec'; % Shutter time table and gain
