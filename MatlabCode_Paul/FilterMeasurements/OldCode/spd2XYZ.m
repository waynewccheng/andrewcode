...
function [XYZ, CovXYZ] = spd2XYZ(sig_m, sig_s, s);
...
% XYZ coordinates
if strcmp(s, 'sample') % 0 is for the reference white, no disp
...
% Uncertainties
if strcmp(s, 'sample') % 0 is for the reference white, no uncertainties, no disp
