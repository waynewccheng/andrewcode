...
[lambda, spectra, ROI] = f_meas_spectro(ol490, pr, ludl, n_meas, 0);
...
for j = 1:3 % 1 is filter, 2 is 100% transmittance, 3 is 0% transmittance
    ...
    % Acquire data
    camera2frame_9MP_small_PL2([path_to_rdata '\' folders{j}], numberofshots, ol490, int8(intensities(:, 2)), bandwidth, shutter_tbl(:, 2));
